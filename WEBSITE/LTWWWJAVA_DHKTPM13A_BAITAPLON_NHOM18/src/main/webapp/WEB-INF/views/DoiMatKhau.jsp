				...
				<div class="card-body">
					...
					<div class="row row-space">
						...
						<div class="row row-space">
							...
							<div class="row row-space">
							<div class="col-2">
								 <input value="${thongtin.pass }
										class="input--style-4 validate-input" type="hidden"
										name="pass" required>
								<input value="${thongtin.username }
										class="input--style-4 validate-input" type="hidden"
						...
						<div class="p-t-15">
							...
							<a href="Home"><button class="btn btn--radius-2 btn--blue">Hủy</button></a>
						</div>
					</form:form>
