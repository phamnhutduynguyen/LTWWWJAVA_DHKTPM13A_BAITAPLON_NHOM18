		...
		<div class="wrapper wrapper--w680">
			<div class="card card-4">
				...
				<p class="text-danger">
					...
					<h2 class="title">Chỉnh sửa thông tin tài khoản cá nhân</h2>
					<label class="label" >Thông tin tài khoản:  <c:out value="${thongtin.username }"></c:out></label> <br>
					<form:form ModelAttribute="nguoidung" method="POST" action="ThayDoiThongTin">
					<div class="row row-space">
						<div class="col-2">
							<div class="input-group">
								<label class="label">Họ tên</label> 
								<input value="${thongtin.tenNguoiDung }"
						...
						<div class="col-2">
								<div class="input-group">
									<label class="label">Địa chỉ</label> <input value="${thongtin.diaChi }"
						...
						<div class="row row-space">
							<div class="col-2">
								<div class="input-group">
									<label class="label">Email</label> <input value="${thongtin.email }"
										class="input--style-4" type="email" name="email">
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
									<label class="label">Số điện thoại</label> <input value="${thongtin.soDienThoai }"
										class="input--style-4 validate-input" type="text"
							...
							<br>
							<p style="color:blue;">Nếu muốn thay đổi mật khẩu thì vui lòng điền đầy đủ thông tin phía dới.</p> 
							<div class="col-2">
								<div class="input-group">
									<label class="label">Mật khẩu cũ</label> <input
							...
							<div class="col-2">
								<div class="input-group">
									<label class="label">Mật khẩu mới</label> <input
										class="input--style-4 validate-input" type="password"
										name="pass" >
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
									<label class="label">Gõ lại mật khẩu mới</label> <input
										class="input--style-4 validate-input" type="password"
						...
						<div class="p-t-15">
							<button class="btn btn--radius-2 btn--blue" type="submit">Cập nhật thông tin</button>
							<a href="<c:url value="/"/>"><button class="btn btn--radius-2 btn--blue">Hủy</button></a>
						</div>
					</form:form>
